...
#define FR_LEFT_BRACKET \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_5_AND_PERCENT))))
...
/* | */
#define FR_PIPE (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_L))))
...
#define FR_NO_BREAK_SPACE \
  (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_SPACEBAR)))
...
/* ¢ */
#define FR_CENT (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_C))))
...
#define FR_FEMININE_ORDINAL_INDICATOR \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_U))))
...
/* ¬ */
#define FR_NOT (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_L)))
...
#define FR_MIDDLE_DOT \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_F))))
#define FR_MIDDOT (FR_MIDDLE_DOT)

/* º */
#define FR_MASCULINE_ORDINAL_INDICATOR \
  (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_U)))
#define FR_ORDM (FR_MASCULINE_ORDINAL_INDICATOR)

/* » */
#define FR_RIGHT_ANGLE_QUOTE \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_7_AND_AMPERSAND))))
#define FR_RAQUO (FR_RIGHT_ANGLE_QUOTE)

/* ¿ */
#define FR_INVERTED_QUESTION \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_M))))
#define FR_IQMARK (FR_INVERTED_QUESTION)

/* ß */
#define FR_SHARP_S (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_B)))
...
#define FR_A_CIRCUMFLEX \
  (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_W)))
#define FR_A_CIRC (FR_A_CIRCUMFLEX)

/* å */
#define FR_A_RING \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_6_AND_CARET))))
...
#define FR_E_CIRCUMFLEX \
  (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_E)))
...
/* Ì */
#define FR_I_GRAVE (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_H)))

/* Í */
#define FR_I_ACUTE \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_J))))

/* î */
#define FR_I_CIRCUMFLEX \
  (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_I)))
#define FR_I_CIRC (FR_I_CIRCUMFLEX)

/* Ï */
#define FR_I_UMLAUT (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_J)))

/* Ò */
#define FR_O_GRAVE (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_S)))
...
/* Ú */
#define FR_U_ACUTE (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_Y)))

/* ı */
#define FR_I_DOTLESS \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_N))))

/* π */
#define FR_PI (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_P)))
...
#define FR_SINGLE_LOW_9_QUOTE \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_R))))
...
#define FR_RIGHT_DOUBLE_QUOTE \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_3_AND_HASH))))

/* „ */
#define FR_DOUBLE_LOW_9_QUOTE \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_2_AND_AT))))
...
#define FR_SINGLE_LEFT_POINTING_ANGLE_QUOTE \
  (RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_Z)))

/* › */
#define FR_SINGLE_RIGHT_POINTING_ANGLE_QUOTE \
  (LS(RA(ZMK_HID_USAGE(HID_USAGE_KEY, HID_USAGE_KEY_KEYBOARD_Z))))
